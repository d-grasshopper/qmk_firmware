...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  LSFTSLS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,  \
  KC_NO, KC_LCTL, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_RGUI, KC_RALT, KC_NO,   KC_RCTRL  \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  LSFTGRV, KC_UNDS, KC_LPRN, KC_DEL, KC_MINS, KC_LBRC,  KC_RBRC, KC_EQL, KC_INS, KC_RPRN, KC_PLUS, KC_RSFT, \
  PRSCR, KC_NO, KC_LGUI, KC_LALT, KC_NO, KC_SPC, KC_ENT, KC_NO, KC_RGUI, KC_RALT, KC_NO, KC_RCTRL \
),
